...
func TestLatestRelease(t *testing.T) {
	...
	tag, url, err := latestRelease(client, "NiallBrickell/pilot", "pilot-darwin-arm64")
	if err != nil {
	...
	if _, _, err := latestRelease(client, "NiallBrickell/pilot", "pilot-no-such-asset"); err == nil {
